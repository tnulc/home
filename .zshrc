...
[[ -s "$Z/opts.zsh" ]] && source "$Z/opts.zsh"
[[ -s "$Z/zstyle.zsh" ]] && source "$Z/zstyle.zsh"
[[ -s "$Z/grep.zsh" ]] && source "$Z/grep.zsh"
[[ -s "$Z/functions.zsh" ]] && source "$Z/functions.zsh"
[[ -s "$Z/bindings.zsh" ]] && source "$Z/bindings.zsh"
[[ -s "$Z/prompt.zsh" ]] && source "$Z/prompt.zsh"
